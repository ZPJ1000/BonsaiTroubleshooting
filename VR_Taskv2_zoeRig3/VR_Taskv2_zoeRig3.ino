...
// after a trial, the outcome is sent back: dirtouch (1,2 for NG,G) and taskoutcome 0,1,2 for FA,Miss
// import libraries
#include <Servo.h>
//#include <toneAC2.h>
...
// sensor inputs
int lsense = 0;  // left spout touch sensor input
int rsense =0; // right spout touch sensor input
...
void FalseAlarm() {
  if (active == 6 && !whiteNoisePlaying) {
   ...
   endtrialdur = fa_endtrialdur;  // Longer timeout for False Alarm
  }
